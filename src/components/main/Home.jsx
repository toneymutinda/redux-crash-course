...
import { fetchJoke, searchJoke, fetchJokeByCategory } from '../../redux/actions/jokeActions'
...
class Home extends React.Component{
    ...
    setJoke = async () => {
       await this.props.searchJoke('funny')
       this.setState({
...
export default connect(
    mapStateToProps, 
    {fetchJoke, searchJoke, fetchJokeByCategory}
) (Home)